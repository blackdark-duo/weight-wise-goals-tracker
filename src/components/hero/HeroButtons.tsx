    ...
    <div className="flex flex-col sm:flex-row gap-4">
      ...
      <Link to="/features">
        <Button 
          variant="outline" 
          size="lg" 
          className="w-full sm:w-auto border-blue-300 hover:bg-blue-50 text-brand-primary transition-all duration-300"
        >
          <BarChart2 className="mr-2 h-4 w-4 text-brand-primary" strokeWidth={1.75} />
          View Features
        </Button>
      </Link>
    </div>
